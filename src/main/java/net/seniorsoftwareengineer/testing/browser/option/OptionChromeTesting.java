...
/**
 * Option test for Chrome Browser Implement OptionTest interface like all class
 * browser specific
 *
 */
public class OptionChromeTesting implements OptionTest {
    private final ChromeOptions options;
    private Configuration configuration;

    public OptionChromeTesting(Configuration configuration) {
	super();
